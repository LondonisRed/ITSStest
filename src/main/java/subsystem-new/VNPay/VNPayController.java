...
public class VNPayController {
    ...
    public Payment refund(int amount, String contents) {
        return null;
    }
    ...
    public Payment makePaymentTransaction(Map<String, String> response) throws IncompleteTransactionException, FailedTransactionException, ReverseTransactionException, UnrecognizedException, ParseException {
        if (response == null) {
            return null;
        }
        ...
        Payment trans = new
                Payment(errorCode, transactionId, transactionContent, amount, date);
