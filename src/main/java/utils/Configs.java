...
public class Configs {
	...
	public static final String INVOICE_SCREEN_PATH = "/app/aims_store/invoice.fxml";
	public static final String INVOICE_MEDIA_SCREEN_PATH = "/app/aims_store/media_invoice.fxml";
	public static final String PAYMENT_SCREEN_PATH = "/app/aims_store/payment.fxml";
	public static final String RESULT_SCREEN_PATH = "/app/aims_store/result.fxml";
	public static final String SPLASH_SCREEN_PATH = "/app/aims_store/splash.fxml";
	public static final String CART_SCREEN_PATH = "/app/aims_store/cart.fxml";
	public static final String SHIPPING_SCREEN_PATH = "/app/aims_store/shipping.fxml";
	public static final String CART_MEDIA_PATH = "/app/aims_store/media_cart.fxml";
	public static final String HOME_PATH  = "/app/aims_store/home.fxml";
	public static final String HOME_MEDIA_PATH = "/app/aims_store/media_home.fxml";
	public static final String POPUP_PATH = "/app/aims_store/popup.fxml";
